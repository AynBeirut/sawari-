...
@media (max-width: 1024px) {
  ...
  .fp-header-block::before { top: 0; height: 100%; transform: none; }
...
@media (max-width: 767px) {
  ...
  .plan-text-container { position: relative; left: 0; top: 0; width: 100%; margin-bottom: 2rem; }
  .plan-viewer { display: flex; flex-direction: column-reverse; }
  .plan-left, .plan-right { min-height: auto; }
  .plan-vline { display: none; }
  .plan-prev { left: 1rem; top: auto; bottom: 1rem; transform: none; }
  .plan-next { right: 1rem; top: auto; bottom: 1rem; transform: none; }
}
;
